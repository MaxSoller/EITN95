public class GlobalSimulation{
	...
	public static final int ARRIVAL_FIRST_QUEUE = 1, READY_FIRST_QUEUE = 2, MEASURE = 3, ARRIVAL_SECOND_QUEUE = 4, READY_SECOND_QUEUE = 5; // The events, add or remove if needed!
